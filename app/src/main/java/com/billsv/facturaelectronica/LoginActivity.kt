...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (isFirstTime) {
            ...
            if (savedPins.isEmpty()) {
                ...
                Toast.makeText(this, "Por favor, crea un nuevo PIN", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    private fun showCreatePinDialog() {
        ...
        input.filters = arrayOf(InputFilter.LengthFilter(6)) // Máximo 6 dígitos
    ...
    private fun setupClickableLink() {
        val text = "Leer más sobre nosotros aquí"
        ...
        val start = text.indexOf("Leer más sobre nosotros aquí")
        val end = start + "Leer más sobre nosotros aquí".length
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        if (requestCode == WRITE_EXTERNAL_STORAGE_REQUEST_CODE) {
            if (grantResults.isNotEmpty() && grantResults.all { it == PackageManager.PERMISSION_GRANTED }) {
                ...
                Toast.makeText(this, "Los permisos son necesarios para realizar el respaldo", Toast.LENGTH_SHORT).show()
            }
        }
    }
}
