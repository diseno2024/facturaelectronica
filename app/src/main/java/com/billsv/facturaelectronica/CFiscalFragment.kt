...
class CFiscalFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        facturaAdapterc = FacturaAdaptercf(requireContext(), mutableListOf()){ factura ->
            // Usamos ViewBinding para inflar el layout
            val binding = ActivityVerPdfCcfBinding.inflate(LayoutInflater.from(requireContext()))
            ...
            binding.vistaPdfCCF.fromFile(pdfFile)
    ...
    private fun generarPdf(factura:Factura): PdfDocument {
        ...
        try {
            ...
            val totalNoSujshow = totalNoSuj.toBigDecimal().setScale(2, RoundingMode.HALF_UP).toString()
            val totalExentashow = totalExenta.toBigDecimal().setScale(2, RoundingMode.HALF_UP).toString()
            val totalGravadashow = totalGravada.toBigDecimal().setScale(2, RoundingMode.HALF_UP).toString()
            ...
            val subTotalVentas = factura.total.toBigDecimal().setScale(2, RoundingMode.HALF_UP).toString()
            ...
            val valor20show = valor20.toBigDecimal().setScale(2, RoundingMode.HALF_UP).toString()
            ...
            val subTotal = factura.total.toBigDecimal()
            val subTotalshow = subTotal.setScale(2, RoundingMode.HALF_UP).toString()
            ...
            val ivaRete1 = 0.00
            val ivaRete1show = ivaRete1.toBigDecimal().setScale(2, RoundingMode.HALF_UP).toString()
            ...
            val reteRenta = 0.00
            val reteRentashow = reteRenta.toBigDecimal().setScale(2, RoundingMode.HALF_UP).toString()
            ...
            val total = factura.total.toBigDecimal()
            val iva= factura.iva.toBigDecimal()
            val monto= total + iva
            montoTotalOperacion = monto.setScale(2, RoundingMode.HALF_UP).toString()
            ...
            val totalNoGravadoShow = totalNoGravado.toBigDecimal().setScale(2, RoundingMode.HALF_UP).toString()
            ...
            totalPagar = totalm.setScale(2, RoundingMode.HALF_UP).toString()
            ...
            canvas.drawText("$nombre1", startX+80, startY + 60, paintTITULO2)
            canvas.drawText("No. documento: ", startX, startY + 70, paintTITULO)
            canvas.drawText("$nit1", startX+60, startY + 70, paintTITULO2)
